...
<!-- sample modal content -->
<div id="add-modal-jobapp" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 id="header-text" class="modal-title">Add New Job Application</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
            <?php
            ...
            ?>
            <?php echo form_open('admin/jobapplication/add','id="add-form-jobapp"',$hidden); ?>
                <div class="form-group row">
                    <label for="recipient-name" class="col-2 control-label">Name: </label>
                    <div class="col-10">
                        <input type="text" name="name" class="form-control" placeholder="A unique name for this category">                        
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                <button type="submit" id="add-submit-jobapp" class="btn btn-info waves-effect waves-light">Save changes</button>
            </div>
            </form>
