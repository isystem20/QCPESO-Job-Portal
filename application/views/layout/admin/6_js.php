...
<?php 
    ...
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrapjs/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrapjs/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrapjs/sidebarmenu.js"></script>
    <!--stickey kit -->
...
<script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/jquery/jquery.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrap/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrap/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/bootstrap/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <script src="<?php echo base_url(); ?>themes/admin-pro/assets/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!--Custom JavaScript -->
