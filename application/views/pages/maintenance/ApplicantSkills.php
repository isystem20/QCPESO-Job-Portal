        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Applicant Skills</h3>
                    <h6 class="text-muted">Masterlist of All Applicant Skills</h6>
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Applicant Skills</li>
                    </ol>
                </div>
                <div>
