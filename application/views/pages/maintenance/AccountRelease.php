        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Account Release</h3>
                    <h6 class="text-muted">This is the Masterlist of all Account Release</h6>
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Account Release</li>
                    </ol>
                </div>
                <div>
