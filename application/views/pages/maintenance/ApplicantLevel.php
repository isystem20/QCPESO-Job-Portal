        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Applicant Level List</h3>
                    <h6 class="text-muted">Masterlist of All Applicant Level</h6>
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Applicant Level</li>
                    </ol>
                </div>
                <div>
